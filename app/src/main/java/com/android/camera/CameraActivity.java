    ...
    public void onCreate(Bundle state) {
        ...
        if (MediaStore.INTENT_ACTION_VIDEO_CAMERA.equals(getIntent().getAction())
            ...
            try {
                ...
                Log.d(TAG, "moduleString1111 = " + moduleIndex);
            } catch (ClassCastException e) {
                e.printStackTrace();
                String moduleString = prefs.getString(CameraSettings.KEY_STARTUP_MODULE_INDEX, "Not found");
                Log.d(TAG, "moduleString = " + moduleString);
                moduleIndex = ModuleSwitcher.PHOTO_MODULE_INDEX;
            }
